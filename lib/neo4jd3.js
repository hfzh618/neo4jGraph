...
//            color = options.colors[Math.min(numClasses, options.colors.length - 1)];
            ...
            */
            ...
            function replaceWithD3Data(d3Data) {
                replaceNodesAndRelationships(d3Data.nodes, d3Data.relationships);
            }
            ...
            function replaceNodesAndRelationships(n, r) {
                replaceRelationships(r);
                replaceNodes(n);
            ...
            function replaceRelationships(r) {
                relationships = r;
                // Array.prototype.push.apply(relationships, r);
...
//        smoothTransform(svgTranslate, svgScale);
            ...
            return {
                ...
                replaceWithD3Data: replaceWithD3Data,
